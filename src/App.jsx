  ...
  render () {
    return (
      <div>
        ...
        <h3>Why.</h3>
        <p>Been an Angular.js guy for a while, decided to learn React.js, loving it so far.</p>
        <a href="#" className="github-link"><i className="fa fa-github" aria-hidden="true"></i> Client code</a>
        <a href="#" className="github-link"><i className="fa fa-github" aria-hidden="true"></i> Api code</a>
      </div>
    )
  }
}
